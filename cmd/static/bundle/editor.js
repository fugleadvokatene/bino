...
var D3 = class {
  ...
  fillImage(i) {
    ...
    let r = "load";
    a3 === "VIDEO" && (s2.autoplay = true, s2.loop = true, s2.muted = true, s2.playsinline = true, r = "loadeddata"), this.nodes.imageEl = S4(a3, this.CSS.imageEl, s2), this.nodes.imageEl.addEventListener(r, () => {
      this.toggleStatus(
        "filled"
        /* Filled */
...
var A4 = class {
  ...
  uploadByUrl(i) {
    let a3;
    this.config.uploader && typeof this.config.uploader.uploadByUrl == "function" ? (a3 = this.config.uploader.uploadByUrl(i), O3(a3) || console.warn("Custom uploader method uploadByUrl should return a Promise")) : a3 = j3.post({
  ...
  uploadByFile(i, { onPreview: a3 }) {
    ...
    let r;
    if (this.config.uploader && typeof this.config.uploader.uploadByFile == "function")
      r = this.config.uploader.uploadByFile(i), O3(r) || console.warn("Custom uploader method uploadByFile should return a Promise");
    else {
